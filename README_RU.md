...
**Режим Форума** — Telegram-супергруппа с Темами. Каждый проект получает свой тред с deep-link навигацией между топиками. Богатые inline-кнопки действий на каждом сообщении — Continue, Diff, Files, History, New session. Автоматическое создание проектных топиков. Тема задач для управления Kanban. Тема активности с прямыми URL-кнопками для перехода в любой проект.
...
|----------|----------|
| **Чат** | Потоковая передача в реальном времени, вставка скриншотов, прикрепление файлов (`@file`), ветвление разговора, автопродолжение (3x), сжатие сессий |
...
| **Telegram** | Управление через бота, push-уведомления, перенаправление ask_user, мост сессий, режим Форума, встроенная остановка, deep-link навигация, rich action buttons |
