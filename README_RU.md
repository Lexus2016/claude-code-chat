...
**Режим Форума** — Telegram-супергруппа с Темами. Каждый проект получает свой тред. Тема задач для управления Kanban. Тема активности для уведомлений с интерактивными кнопками навигации.
...
| **Telegram** | Управление через бота, push-уведомления, перенаправление ask_user, мост сессий, режим Форума, встроенная остановка |
...
| **Платформа** | Windows/macOS/Linux, Docker, 3 языка (EN/UA/RU), поддержка OpenRouter |
